...
export default function UserList() {
  ...
  const filteredUsers = users.filter(user=>{
    return (user.name.toLowerCase().includes(query.toLowerCase()) ||user.occupation.toLowerCase().includes(query.toLowerCase()))
  })
  ...
  return (
    <div className="flex flex-col gap-2 ">
      ...
      {filteredUsers.length===0 && <NoUserFoundPage msg={"No User Found Based On Your Search !"} />}
      <div
